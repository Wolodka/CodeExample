...
{
    class LifetimeIntraserviceTaskId : AppEntityConvertableAttribute<TaskLifeTime, int>
    {
        public LifetimeIntraserviceTaskId(TaskLifeTime lifetime, IntConverter converter)
            : base(lifetime, converter)
        { }

        public override void AssignToCrmEntity()
        {
            _converter.Set(_appEntity.TaskId);
        }

        public override void AssignToAppEntity()
        {
            _appEntity.TaskId = _converter.GetOrDefault();
        }
    }
}
